...
{
    "use strict";
    function s() { return /(Android|webOS|Phone|iPad|iPod|BlackBerry|Windows Phone)/i.test(navigator.userAgent) }
    function e() {
        $(".homepage-header").css({ width: $(window).width(), height: $(window).height() })
    }
    function a(s) {
    ...
    $("#do-open-menu").on("click", function (s) {
        s.preventDefault(),
    ...
    $(".homepage-header").vegas({
        ...
        slides: [
        {
            src: "/Uploads/link/logochuan.jpg",
            color: "#DBC9B3",
            transition: "fade2",
        ...
        {
            src: "/Uploads/anh/a2.jpg",
            color: "#D3A87E",
            transition: "swirlRight"
        },

        {
            src: "/Uploads/anh/a3.jpg",
            color: "#E2DC56",
            animation: "kenburns"
        },

        {
            src: "/Uploads/anh/a1.jpg",
            color: "#DBC9B3",
            animation: "kenburns",
    ...
    t >= i.length && (t = 0);
    var n = i[t];
    t++, localStorage.setItem("theme-index", t),
    ...
    $(".transition-list li").on("click", function (s) {
        var e; s.preventDefault(),
        $(".transition-list li").removeClass("active"), e = $(this).text(),
        $(this).addClass("active"), $("#test3-1").vegas("options", "transition", e),
            $("#code-transition").text(e)
    }),
    $("#test3-2").vegas({
        slides: [{ src: "/img/unsplash1.jpg" }, { src: "/img/unsplash2.jpg" }, { src: "/img/unsplash3.jpg" }, { src: "/img/unsplash4.jpg", valign: "25%" }],
        animation: "kenburns"
    }),
    $(".animation-list li").on("click", function (s) {
        var e; s.preventDefault(),
        $(".animation-list li").removeClass("active"), e = $(this).text(), $(this).addClass("active"), $("#test3-2").vegas("options", "animation", e),
    ...
    $(".method-list li").on("click", function (s) {
        var e; s.preventDefault(),
        $(".method-list li").removeClass("active"), e = $(this).data("method"),
        $(this).addClass("active"), "first" === e ? $("#test4-1").vegas("jump", 0) : "last" === e ? $("#test4-1").vegas("jump", 3) : $("#test4-1").vegas(e),
    ...
    $("#do-test4-2").on("click", function (s) {
        ...
        $("#" + e + " .add").on("click", function (s) {
            var a = $("#" + e).vegas("options", "slides"); a.push(i[0]), i.shift(),
 $("#" + e).vegas("options", "slides", a).vegas("options", "transition", "slideDown").vegas("jump", a.length - 1).vegas("options", "transition", "slideLeft2"), 0 === i.length && $(this).fadeOut(), s.preventDefault()
        }), s.preventDefault()
    })
});
