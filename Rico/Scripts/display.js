...
(function ($) {
    ...
    var listChildren;//Lưu các con trong lõi khung cuộn
    var currentChildIndex = 0;//Lưu chỉ số của con hiện tại (con trong lõi khung cuộn đang đứng đầu trong các các được hiển thị)
